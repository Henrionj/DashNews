...
public class IndicatorPage extends Page {
	...
	{	
	    ...
	    JInternalFrame ind = new JInternalFrame(items.get(2).getName(), false,true, false, false);
		...
		constraints.gridwidth = 1;
	    //constraints.fill = constraints.BOTH;
	    JInternalFrame ind2 = new JInternalFrame(items.get(3).getName(), false,true, false, false);
		...
		constraints.gridwidth = 1;
	    //constraints.fill = constraints.BOTH;
	    JInternalFrame ind3 = new JInternalFrame(items.get(4).getName(), false,true, false, false);
	  ...
	  //------------------------------------------------------------------------------------
		...
		constraints.gridwidth = 1;
	    //constraints.fill = constraints.BOTH;
	    JInternalFrame ind4 = new JInternalFrame(items.get(5).getName(), false,true, false, false);
		...
		constraints.gridwidth = 1;
	    //constraints.fill = constraints.BOTH;
	    JInternalFrame ind5 = new JInternalFrame(items.get(6).getName(), false,true, false, false);
