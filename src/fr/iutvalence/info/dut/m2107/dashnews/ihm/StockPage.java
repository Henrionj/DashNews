...
public class StockPage extends Page {
	...
	public void layItems() {
		...
		JInternalFrame ind1 = new JInternalFrame(this.items.get(0).getName(),
				false, true, false, false);
		ind1.setSize(new Dimension(this.items.get(0).getLength(), this.items
				.get(0).getHeight()));
		ind1.setLayout(null);
		JPanel panel1 = new JPanel();
		JLabel label1 = new JLabel();
		label1.setText("Tableau des stock de produit");
		panel1.add(label1);
		JScrollPane scrollPane1 = new JScrollPane(panel1);
		scrollPane1.setBounds(0, 0, 275, 160);
		JPanel panel12 = new JPanel();
		JLabel label12 = new JLabel();
		label12.setText("Info liste produit");
		panel12.add(label12);
		...
		label2.setText("Tableau des stock de produit");
		panel2.add(label2);
		JScrollPane scrollPane2 = new JScrollPane(panel2);
		scrollPane2.setBounds(0, 0, 275, 160);
		JPanel panel22 = new JPanel();
		JLabel label22 = new JLabel();
		label22.setText("Info liste produit");
		panel22.add(label22);
		...
		JInternalFrame ind3 = new JInternalFrame(this.items.get(2).getName(),
				false, true, false, false);
		ind3.setSize(new Dimension(this.items.get(2).getLength(), this.items
				.get(2).getHeight()));
